...
- mosaic engine features (ECS, rendering, platform, etc.)
...
3. **No mosaic coupling**: MUST remain independent of mosaic engine (can parse any C++ project)
...
**Forbidden:**
- ❌ mosaic headers — codex is tooling, not engine-coupled
...
- mosaic does NOT depend on codex (unidirectional)
...
- [ ] Test on real mosaic headers (mosaic/include/mosaic/**/*.hpp)
