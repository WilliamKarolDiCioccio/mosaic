# TargetCompileOptions.cmake
# A reusable CMake module to apply compile options and link options based on the build type
#
# Usage:
#   include(cmake/TargetCompileOptions.cmake)
...
function(configure_for_build_type target)
  ...
  if(CMAKE_CXX_COMPILER_ID MATCHES "GNU|Clang|AppleClang")
    target_compile_options(${target} PRIVATE
      $<$<CONFIG:Sanitizers>:-g -O0 -fno-omit-frame-pointer -fno-optimize-sibling-calls -fno-inline -fno-common -fms-runtime-lib=dll_dbg -fsanitize=address -fsanitize=undefined -fsanitize=thread>
    )
    target_compile_definitions(${target} PRIVATE
      $<$<CONFIG:Sanitizers>:MOSAIC_SANITIZERS>
    )
    target_link_options(${target} PRIVATE
      $<$<CONFIG:Sanitizers>:-fsanitize=address -fsanitize=undefined -fsanitize=thread>
    )
  elseif(CMAKE_CXX_COMPILER_ID MATCHES "MSVC")
    target_compile_options(${target} PRIVATE
      $<$<CONFIG:Sanitizers>:/Zi /Od /RTC1 /DEBUG:FULL /MDd /fsanitize=address>
    )
    target_compile_definitions(${target} PRIVATE
      $<$<CONFIG:Sanitizers>:MOSAIC_SANITIZERS>
    )
