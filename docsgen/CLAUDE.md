...
**Forbidden:**
- ❌ mosaic headers — docsgen is tooling, not engine-coupled
...
- mosaic does NOT depend on docsgen (tooling, not library)
...
- ⚠️ **Large output files**: Generating docs for entire mosaic codebase produces 100s of files
...
- [ ] Run docsgen on full mosaic/include directory (stress test)
